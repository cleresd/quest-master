...
import { GetLastFiveMinsAllChat as GetLastFiveMinsAllChat, GetRoom, GetRoomChat, GetUserCurrentRoom } from '../sockets/sockets';
        ...
        const banData = {
            ipBan:
                ...
                req.body['SingleIPBanCheckbox'] === 'on'
                    ? true
                    : false,
            singleIPBan: req.body['SingleIPBanCheckbox'] === 'on'
                ? true
                : false,
            userBan: req.body['userBanCheckbox'] === 'on'
                ? true
                : false,
            bannedPlayer: {
                id: banUser._id,
...
router.post('/report', async ( req, res ) => {
    ...
    const voteHistory = roomId
        ? JSON.stringify(GetRoom(roomId).voteHistory)
        : '';
